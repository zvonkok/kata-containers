...
export POD_NAMESPACE_EMBEDQA="nim-embedqa"

export RUNTIME_CLASS_NAME="kata-qemu-nvidia-gpu-cicd"
...
setup() {
	...
	pod_instruct_yaml_in="${pod_config_dir}/pod-nvidia-nim-llama-3.1-8b-instruct.yaml.in"
	pod_instruct_yaml="${pod_config_dir}/pod-nvidia-nim-llama-3.1-8b-instruct.yaml"

	pod_embedqa_yaml_in="${pod_config_dir}/pod-nvidia-nim-llama-3-2-nv-embedqa-1b-v2.yaml.in"
	pod_embedqa_yaml="${pod_config_dir}/pod-nvidia-nim-llama-3-2-nv-embedqa-1b-v2.yaml"
...
#	export POD_IP_EMBEDQA=$(kubectl get pod "${POD_NAME_EMBEDQA}" -n "${POD_NAMESPACE_EMBEDQA}" -o jsonpath='{.status.podIP}')
#}
