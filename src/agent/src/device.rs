...
pub async fn handle_cdi_devices(
    ...
    // This is only valid for go-runtime, runtime-rs does not have a sandbox container
    if let Some(container_type) = spec.annotations.get("io.katacontainers.pkg.oci.container_type") {
