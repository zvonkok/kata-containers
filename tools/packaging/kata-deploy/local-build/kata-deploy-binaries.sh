...
install_cached_tarball_component() {
	...
	[[ "${cached_image_version}" != "${current_image_version}" ]] && { cleanup_and_fail "${component_tarball_path}" "${extra_tarballs}"; return 1; }
	[[ "${cached_version}" != "${current_version}" ]] && { cleanup_and_fail "${component_tarball_path}" "${extra_tarballs}"; return 1; }
